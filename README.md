...
| `bank_compact`     | `space_id`, `dry_run?`            | 🔧 Losslessly splits oversized bank files in UTF-8 bytes, with pre-write backup and SHA-256 verification. `dry_run=True` by default (manage) |
